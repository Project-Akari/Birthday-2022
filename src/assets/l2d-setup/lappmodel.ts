...
export class LAppModel extends CubismUserModel {
  ...
  public constructor(eventCallback: LAppDefine.L2EventFunction) {
    ...
    this._enaMotions = new CubismMotionManager(); // <<<追加！
    this._enaExpressions = new CubismMotionManager();  // <<<追加！
  }

  _isMotionCompleted: boolean;

  _enaMotions: CubismMotionManager;    /// <<< 追加！
  _enaExpressions: CubismMotionManager;     /// <<< 追加！
  ...
  _wavFileHandler: LAppWavFileHandler; //wavファイUnexpected token. A constructor, method, accessor, or property was expectedルハンドラ
